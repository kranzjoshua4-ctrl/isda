...
export function BookingCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "rounded-none border border-[rgba(148,163,184,0.28)] bg-white/90 shadow-[0_14px_40px_rgba(15,23,42,0.06),0_6px_16px_rgba(15,23,42,0.04)]",
        compact ? "rounded-none p-2.5 md:p-3" : "p-5 sm:p-6",
        className,
      )}
    >
      {compact ? (
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-stretch sm:justify-between sm:gap-6">
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-3 flex items-start gap-3">
              <span
                className="mt-1 inline-flex size-9 shrink-0 items-center justify-center rounded-none border border-[rgba(31,78,121,0.18)] bg-[rgba(31,78,121,0.08)] text-[#1f4e79]"
                aria-hidden
              >
            ...
            <div className="mt-4 flex items-start gap-3">
              <span
                className="mt-1 inline-flex size-9 shrink-0 items-center justify-center rounded-none border border-[rgba(148,163,184,0.32)] bg-[#f8fafc] text-[#475569]"
                aria-hidden
              >
          ...
          <div className="flex shrink-0 flex-col items-start justify-center rounded-none border border-[rgba(148,163,184,0.32)] bg-[#f8fafc] px-4 py-3 sm:items-end sm:border-0 sm:bg-transparent sm:px-0 sm:py-0 sm:text-right">
            <p className="text-[0.55rem] font-semibold uppercase tracking-[0.18em] text-[#64748b]">
              Servicegebühr
            </p>
